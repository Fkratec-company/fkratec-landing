  ...
  ar: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "تطبيقات الجوال", text: "تجارب iOS وAndroid بإحساس أصلي، حركة ناعمة وتفاعل قوي." },
        { title: "تصميم واجهات UX/UI", text: "واجهات سينمائية، أنظمة تصميم، ونماذج توحّد الفريق." },
        { title: "حلول الذكاء الاصطناعي", text: "مساعدين، أتمتة، وسير عمل ذكية بقيمة عملية حقيقية." },
        { title: "منصات SaaS", text: "من الفوترة والصلاحيات إلى التحليلات وأساسيات multi-tenant." },
